...
echo.[41m
echo.ERROR^^!^^!^^! EXE NOT FOUND IN GAME FOLDER^^!^^!^^! 
echo.^(%gamepath%\bin\bg3.exe^)
echo.
echo.VERIFY YOUR STEAM FILES^^!^^!^^!
echo.[0m
...
echo.
echo.If this has found the wrong location, thats ok
echo.Relaunch the script and it will ask for the proper location
echo.
echo.This File was generated by the BG3MOD cmd installer. Please delte this file if it is not needed.> %temp%/bg3mi.tmp
pause
exit
)
...
echo.[41mThis script was built for game version[94m %gamever%[0m[41m
